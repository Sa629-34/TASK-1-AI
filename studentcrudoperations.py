...
def create_student(student_id, name, age, grades):
    ...
    :param student_id: str - Unique identifier for the student
    :param name: str - Name of the student
    :param age: int - Age of the student
    :param grades: list - List of grades for the student
    """
...
def read_student(student_id):
    """
    Display details of a student by their ID.
    :param student_id: str - Unique identifier for the student
    """
    if student_id in students:
...
def update_student(student_id, name=None, age=None, grades=None):
    ...
    :param student_id: str - Unique identifier for the student
    :param name: str - Updated name (optional)
    :param age: int - Updated age (optional)
    :param grades: list - Updated grades (optional)
    """
    if student_id in students:
        if name:
